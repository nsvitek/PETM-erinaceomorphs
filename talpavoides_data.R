...
metrics<-c("ic.eh/length","tal.w.l","tri.h.l","ic.hh.l",
           "met.w.tri","ento.l.l","cant")
metric_names<-c("ic-entohypu","tal-w-length","tri-h-length","ic-hypohypu",
                "met-w-tri","ento-l-length","cant")
...
shapemetadata<-read.csv(paste(datadir,
                              "talpavoides_manuscript.csv",sep="/"))
